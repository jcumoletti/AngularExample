# [Angular Example with ngBoilerplate](https://github.com/jcumoletti/AngularExample)

***

## Goals

Create a sample Angular app to showcase some of my code. Sample project allows for:
